...
@NgModule({
    providers: [
        ...
        ApiServiceProxies.ChargesServiceProxy,
        ApiServiceProxies.TaxServiceProxy,
        ApiServiceProxies.PersonnelServiceProxy,
        ApiServiceProxies.ApplicationsServiceProxy,
        ApiServiceProxies.StandardReferenceServiceProxy,
        ApiServiceProxies.StandardRemarkServiceProxy,
        ApiServiceProxies.TechniqueServiceProxy,
        ApiServiceProxies.UnitServiceProxy,
        ApiServiceProxies.SubApplicationServiceProxy,
        ApiServiceProxies.CustomerMasterServiceProxy,
        ApiServiceProxies.TestMasterServiceProxy,
        ApiServiceProxies.TestPlanMasterServiceProxy,
