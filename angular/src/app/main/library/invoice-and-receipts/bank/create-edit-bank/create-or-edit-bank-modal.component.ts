...
import { BankDto, BankInputDto, BankServiceProxy, ResponseDto } from '@shared/service-proxies/service-proxies';
...
export class CreateOrEditBankModalComponent extends AppComponentBase {
    ...
    @Output() restoreBank: EventEmitter<ResponseDto> = new EventEmitter<ResponseDto>();
        ...
        this._bankService
            ...
            .subscribe((response : ResponseDto) => {
                if(!response.dataMatchFound){
                    ...
                    this.close();
                    this.restoreBank.emit(response);
                }
            });
    }
